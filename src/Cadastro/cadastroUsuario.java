...
import daoCliente.cDAOCADASTRO;
...
public class cadastroUsuario extends JFrame {
	...
	private JTextField txtCEL_DADOS;
	...
	cDAOCADASTRO CdaoCADASTRO = new cDAOCADASTRO();
	...
	public cadastroUsuario() {
		...
		javax.swing.text.MaskFormatter format_CPF = null;
		try {
			format_CPF = new javax.swing.text.MaskFormatter("###.###.###-##");
		} catch (ParseException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		...
		setTitle("M\u00FCll - Cadastro Usu\u00E1rio ");
		...
		btnSair.setBounds(940, 598, 326, 47);
		...
		txtNOM_EM.setBounds(191, 103, 341, 22);
		panel.add(txtNOM_EM);
		...
		txtCNPJ = new javax.swing.JFormattedTextField(format_CPF);
		txtCNPJ.setBounds(191, 162, 341, 22);
		panel.add(txtCNPJ);
		txtCNPJ.setText("--------");
		txtCNPJ.setColumns(10);

		JLabel lblIe = new JLabel("Celular");
		...
		txtCEL_DADOS = new javax.swing.JFormattedTextField(format_CEP);
		txtCEL_DADOS.setBounds(602, 218, 213, 22);
		panel.add(txtCEL_DADOS);
		txtCEL_DADOS.setText("---------");
		txtCEL_DADOS.setColumns(10);
		...
		JLabel lblCadastroParceiro = new JLabel("Cadastro Usuario");
		...
		lblSobrenome.setBounds(544, 106, 88, 16);
		panel.add(lblSobrenome);
		
		txtSobrenome = new JTextField();
		txtSobrenome.setBounds(617, 103, 198, 22);
		...
		btnCadastar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				Cusuario.setCOD_ENDERECO_USUARIO(endereco.getCOD_ENDERECO());
				System.out.println(Cusuario.getCOD_ENDERECO_USUARIO()+"COD ENDERECO USUARIO");
				CdaoCADASTRO.InsertNewDados(Cusuario);
				CdaoCADASTRO.QueryCOD_DADOS(Cusuario);
				CdaoCADASTRO.InsertDadosUsuario(Cusuario);
				
				CdaoCADASTRO.QUERYCOD_USUARIO(Cusuario);
				CADASTRO.setCOD_USUARIO(Cusuario.getCOD_Usuario());
				System.out.println(CADASTRO.getCOD_USUARIO());
				DaoCADASTRO.InsertCaixadeMensagensUsuario(CADASTRO);
	...
	public void getDados() {
		endereco.setCEP_ENDERECO(txtCEL_DADOS.getText());
		endereco.setEND_ENDERECO(txtEND_US.getText());
		endereco.setCOM_ENDERECO(txtCOMPLEMENTO_US.getText());
		Cusuario.setCPF_DADOS(txtCNPJ.getText());
		Cusuario.setEMA_USUARIO(txtEMA.getText());
		Cusuario.setSOB_NOM_DADOS(txtSobrenome.getText());
		Cusuario.setNOM_DADOS(txtNOM_EM.getText());
		Cusuario.setSEN(txtSenha.getText());
		Cusuario.setTEL_DADOS(txtTEL_EMP.getText());
		Cusuario.setCEL_DADOS(txtCEL_DADOS.getText());
	}
	...
	public void Verificacaotexto(){
		...
		if(txtCEL_DADOS.getText().equalsIgnoreCase("")||
