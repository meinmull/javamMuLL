...
public class SolicitacaoVidro extends JFrame {
	...
	public SolicitacaoVidro() {
		
		setTitle("Cliente - Solicitar coleta vidro.");
		...
		CdaoMULL.cbxDescricao.setModel(new DefaultComboBoxModel(new String[] { "", }));
		...
		btnConcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				CdaoMULL.CODVERIFICADORPARAINSERTVIDRO(Cmull);
				CdaoMULL.InsertNEWVIDRO(Cmull);
				CdaoMULL.QUERYNEWVIDRO(Cmull);
				CdaoMULL.InsertVidro_TO_mMuLLVIDRO(Cmull);
				CdaoMULL.QUERY_COD_mMuLLVidro(Cmull);
