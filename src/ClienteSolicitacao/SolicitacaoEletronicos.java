...
public class SolicitacaoEletronicos extends JFrame {
	...
	public SolicitacaoEletronicos() {
		setTitle("Cliente - Solicitar coleta eletrônico.");
		...
		CdaoMULL.cbxDescricao.setBounds(151, 40, 191, 24);
		...
		CdaoMULL.cbxDescricao.setModel(new DefaultComboBoxModel(new String[] { "", "Tv, Monitor", "Celular", "Placas e componentes",
				"Baterias e pilhas", "Computadores e Notebooks", "Eletrodom\u00E9sticos", "Outros. ", "Misto" }));
		...
		CdaoMULL.cbxPeso.setBounds(151, 83, 191, 24);
		panel_6.add(CdaoMULL.cbxPeso);
		CdaoMULL.cbxPeso.setForeground(Color.WHITE);
		CdaoMULL.cbxPeso.setBackground(Color.DARK_GRAY);
		CdaoMULL.cbxPeso.setModel(new DefaultComboBoxModel(new String[] { "", "ate  1  \t kg", "1 -   2  \t kg",
				"2 -   5  \t kg ", "5 - 10\t kg", "+ de 10 kg", "+ de 20 kg", "+ de 40 kg" }));
		...
		btnConcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				CdaoMULL.InsertNEWELETRONICO(Cmull);
				CdaoMULL.QUERYNEWELETRONICO(Cmull);
				
				CdaoMULL.InsertELETRONICO_INTO_mMuLL(Cmull);
				CdaoMULL.QUERY_COD_mMuLLEL(Cmull);
				cDISPONIBILIDADE.setCOD_MULL(Cmull.getCOD_MULL());
				System.out.println(cDISPONIBILIDADE.getCOD_MULL());
				System.out.println("get cod hora quarta"+cDISPONIBILIDADE.getCOD_HOR_QUA());
				System.out.println("get cod hora sabado : "  + cDISPONIBILIDADE.getCOD_HOR_SAB());
				...
				System.out.println(CdaoMULL.txtPecas.getText());
