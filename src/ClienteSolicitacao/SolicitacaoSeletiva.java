...
public class SolicitacaoSeletiva extends JFrame {
	...
	public SolicitacaoSeletiva() {
		
		setTitle("Cliente - Solicitar coleta seletiva.");
		...
		btnConcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				CdaoMULL.CODVERIFICADORPARAINSERTSELETIVA(Cmull);
				CdaoMULL.InsertNEWSeletiva(Cmull);
				CdaoMULL.QUERYNEWSELETIVA(Cmull);
				CdaoMULL.InsertSeletiva_TO_mMuLL(Cmull);
				CdaoMULL.QUERY_COD_mMuLLSeletiva(Cmull);
		...
		CdaoMULL.txtPecas.setEditable(false);
