...
public class SolicitacaoMetal extends JFrame {
	...
	public SolicitacaoMetal() {
		
		setTitle("Cliente - Solicitar coleta metal.");
		...
		btnConcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				CdaoMULL.CODVERIFICADORPARAINSERTMETAL(Cmull);
				CdaoMULL.InsertNEWMetal( Cmull);
				CdaoMULL.QUERYNEWMETAL( Cmull);
				CdaoMULL.InsertMetal_TO_mMuLL( Cmull);
				CdaoMULL.QUERY_COD_mMuLLMETAL(Cmull);
