...
public class SolicitacaoRoupasECalcados extends JFrame {
	...
	public SolicitacaoRoupasECalcados() {
		...
		setTitle("Cliente - Solicitar coleta roupas e calçados.");
		...
		JLabel lblPares = new JLabel("pares");
		lblPares.setVisible(false);
		lblPares.setFont(new Font("Dialog", Font.PLAIN, 13));
		lblPares.setForeground(Color.WHITE);
		lblPares.setBounds(365, 133, 46, 14);
		panel_6.add(lblPares);
		
		
		CdaoMULL.cbxDescricao.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				 if (CdaoMULL.cbxDescricao.getSelectedItem().equals("Calcados")){
					 lblPares.setVisible(true);}
					 else lblPares.setVisible(false);
			}
		});
		...
		btnConcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				CdaoMULL.CODVERIFICADORPARAINSERTRC(Cmull);
