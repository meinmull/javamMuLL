...
public class EmpresaParceiroIniciarColetas extends JFrame {
	...
	public EmpresaParceiroIniciarColetas() {
		...
		setTitle("Empresa - Iniciar coletas ");
		...
		DAOmull.cbxmMuLL.setBounds	   (10, 188, 320, 24);
		DAOendereco.cbxBairro.setBounds(10, 450, 320, 24);
		DAOendereco.cbxCidade.setBounds(10, 413, 320, 24);
		DAOendereco.cbxEstado.setBounds(10, 376, 320, 24);
		...
		btnSair.setBounds(12, 584, 310, 41);
		...
		btnConsultar.setBounds(12, 525, 308, 41);
		...
		scrollPane.setBounds(356, 68, 874, 248);
		...
		panel.setBounds(356, 335, 874, 262);
		contentPane.add(panel);
		panel.setLayout(null);
		JScrollPane scrollPane_1 = new JScrollPane();
		scrollPane_1.setBounds(92, 164, 770, 38);
		...
		JLabel lblGenero = new JLabel("M\u00FCll");
		lblGenero.setBounds(1, 136, 115, 16);
		panel.add(lblGenero);
		lblGenero.setForeground(Color.WHITE);
		lblGenero.setFont(new Font("Roboto Light", Font.BOLD, 12));
		...
		btnNaoColetado.setBounds(78, 217, 320, 45);
		panel.add(btnNaoColetado);
		...
		btnColetado.setBounds(476, 217, 320, 45);
		panel.add(btnColetado);
