...
public class EmpresaMensagens extends JFrame {
	...
	public EmpresaMensagens() {
		...
		setTitle("Empresa - Caixa de mensagens");
		...
		scrollPane.setBounds(390, 13, 852, 267);
		...
		btnSair.setBounds(31, 580, 320, 45);
		...
		panel.setBounds(390, 291, 852, 334);
		...
		scrollPane_1.setBounds(93, 232, 738, 89);
		...
		btnExcluirMensagem.setBounds(31, 498, 320, 45);
		contentPane.add(btnExcluirMensagem);
