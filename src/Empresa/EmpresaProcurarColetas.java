...
public class EmpresaProcurarColetas extends JFrame {
	...
	public EmpresaProcurarColetas() {
		...
		int b = 0;
		int c = 0;
		setTitle("Empresa- Procurar novas coletas");
		...
		scrollPane_1.setBounds(123, 143, 409, 56);
	...
	public void apagacampos(){
		DAOcoleta.txtDescricaom.setText(""); 
		DAOcoleta.txtBairo.setText("");
		DAOcoleta.txtCep.setText("");
		DAOcoleta.txtCidade.setText("");
		DAOcoleta.txtComplemento.setText("");
		DAOcoleta.txtData.setText("");
		DAOcoleta.txtDataSolicitacao.setText("");
		DAOcoleta.txtDescricao.setText("");
		DAOcoleta.txtDescricaom.setText("");
		DAOcoleta.txtDia.setText("");
		DAOcoleta.txtEndereco.setText("");
		DAOcoleta.txtFaixaEtaria.setText("");
		DAOcoleta.txtGenero.setText("");
		DAOcoleta.txtObs.setText("");
		DAOcoleta.txtPcs.setText("");
		DAOcoleta.txtPeso.setText("");
		DAOcoleta.txtPeriodo.setText("");
	}
}
