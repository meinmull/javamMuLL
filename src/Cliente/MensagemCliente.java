...
public class MensagemCliente extends JFrame {
	...
	public MensagemCliente() {
		...
		setTitle("Cliente - Caixa de mensagens");
		...
		contentPane.setLayout(null);
				...
				btnSair.setBounds(32, 580, 320, 45);
		...
		scrollPane.setBounds(390, 22, 843, 246);
		...
		panel.setBounds(390, 270, 843, 355);
		...
		scrollPane_1.setBounds(93, 203, 738, 88);
		panel.add(scrollPane_1);
		
		cDAOmensagem.txtMsg = new JTextArea();
		scrollPane_1.setViewportView(cDAOmensagem.txtMsg);
		btnExcluirMensagem.setBounds(261, 297, 320, 45);
		panel.add(btnExcluirMensagem);
