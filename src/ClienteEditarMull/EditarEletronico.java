...
public class EditarEletronico extends JFrame {
	...
	public EditarEletronico() {
		...
		setTitle("Cliente - Editar solicitação eletrônico.");
		...
		btnAlterar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				CdaoMULL.uPDATEeLETRONICO(Cmull);
		...
		// btnCancelarPedido.setIcon(new
		// ImageIcon(menulogin.class.getResource("/Aaimagens/btnExcluirMull.jpg")));
		...
		CdaoMULL.txtCOD_MULL.setEditable(false);
		...
		CdaoMULL.cbxDescricao = new JComboBox();
		 CdaoMULL.cbxDescricao.setModel(new DefaultComboBoxModel(new String[] {"", "Tv, Monitor", "Celular", "Placas e componentes", "Baterias e pilhas", "Computadores e Notebooks", "Eletrodom\u00E9sticos", "Outros. ", "Misto"}));
		CdaoMULL.cbxPeso = new JComboBox();
		CdaoMULL.cbxPeso.setModel(new DefaultComboBoxModel(new String[] {"", "ate  1  	 kg","1 -   2  	 kg","2 -   5  	 kg" ,"5 - 10	 kg"," de 10 kg","+ de 20 kg","+ de 40 kg"}));
		...
		contentPane.add(frame);
		 ...
		 Cmull.setCOD_MULL(cDISPONIBILIDADE.getCOD_MULL());
		  CdaoDISPONIBILIDADE.DiasDAsemana(cDISPONIBILIDADE);
		  CdaoDISPONIBILIDADE.DisponibilidadeColetaMatutino();
		  CdaoMULL. QUERY_mMuLL_ELETRONICO(Cmull);
