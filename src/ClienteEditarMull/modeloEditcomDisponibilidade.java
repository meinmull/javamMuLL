...
public class modeloEditcomDisponibilidade extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					modeloEditcomDisponibilidade frame = new modeloEditcomDisponibilidade();
	...
	public modeloEditcomDisponibilidade() {
		setUndecorated(true);
		...
		setTitle("Cliente - Editar solicitação modelo.");
		...
		JComboBox cbxPeso = new JComboBox();
		
		cbxPeso.setBounds(232, 88, 201, 24);
		panel_6.add(cbxPeso);
		
		JLabel lblPeso = new JLabel("Peso :");
		lblPeso.setFont(new Font("Roboto", Font.BOLD, 15));
		lblPeso.setForeground(Color.WHITE);
		lblPeso.setBounds(72, 92, 56, 16);
		panel_6.add(lblPeso);
