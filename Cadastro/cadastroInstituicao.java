...
public class cadastroInstituicao extends JFrame {
	...
	public cadastroInstituicao() {
		...
		JLabel lblCadastroParceiro = new JLabel("Cadastro Institui\u00E7\u00E3o");
		...
		label.setIcon(new ImageIcon(menulogin.class.getResource("/Aaimagens/fundoInstituicao.jpg")));
		...
		btnCadastar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				DaoEMPRESA.InsertLOGINinstituição(empresa);
