...
public class InicioInstituicao extends JFrame {
	...
	public InicioInstituicao() {
		...
		btnMensagens.setBounds(18, 131, 320, 43);
		panel_1.add(btnMensagens);
		btnMensagens.setBackground(Color.DARK_GRAY);
		...
		btnSolicitarColeta.setBounds(18, 189, 320, 43);
		panel_1.add(btnSolicitarColeta);
		btnSolicitarColeta.setBackground(Color.DARK_GRAY);
		...
		panel.setBounds(12, 235, 916, 356);
		contentPane.add(panel);
		panel.setLayout(null);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(12, 13, 881, 337);
		panel.add(scrollPane);
		
		JLabel framescrollpane = new JLabel("");
		scrollPane.setViewportView(framescrollpane);
		framescrollpane.setIcon(new ImageIcon(menulogin.class.getResource("/Aaimagens/fundoincioInstituicao.jpg")));
		...
		btnMenu.setBounds(1028, 166, 138, 25);
		...
		frame_1.setIcon(new ImageIcon(menulogin.class.getResource("/Aaimagens/ParceiroInicial1.jpg")));
