...
public class InstituicaoPesquisaColetasAgendadas extends JFrame {
	...
	public InstituicaoPesquisaColetasAgendadas() {
		...
		btnCancelarColeta_iFrame.setBounds(148, 180, 135, 37);
		...
		iFrame.setVisible(false);
		btnSair.setBounds(625, 616, 320, 45);
		...
		btnConsultar.setBounds(10, 616, 320, 45);
		...
		txtID.setColumns(10);
		btnCancelarColeta.setBounds(944, 616, 320, 45);
