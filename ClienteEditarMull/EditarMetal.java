...
public class EditarMetal extends JFrame {
	...
	public EditarMetal() {
		...
		btnAlterar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				CdaoMULL.QUERY_COD_METAL(Cmull);
				CdaoMULL.uPDATEMETAL(Cmull);
		...
		btnCancelarPedido.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				CdaoMULL.QUERY_COD_VIDRO(Cmull);
		...
		contentPane.add(frame);
		 ...
		 CdaoMULL.QUERY_mMuLL_METAL(Cmull);
