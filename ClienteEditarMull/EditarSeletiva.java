...
public class EditarSeletiva extends JFrame {
	...
	public EditarSeletiva() {
		...
		btnAlterar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				CdaoMULL.QUERY_COD_SELETIVA(Cmull);
				CdaoMULL.uPDATESELETIVA(Cmull);
		...
		btnAlterar.setBounds(954, 487, 320, 45);
		...
		CdaoMULL.cbxPeso = new JComboBox();
		CdaoMULL.cbxPeso.setModel(new DefaultComboBoxModel(new String[] { "", "ate 1kg", "de 1 a 2kg", "de 2 a 5kg",
				"de 5 a 10kg", "de 10 a 20kg", "de 20 a 50kg", "+ de 50kg" }));
		CdaoMULL.cbxPeso.setBounds(232, 115, 201, 24);
		...
		lblPeso.setBounds(72, 119, 56, 16);
		panel_6.add(lblPeso);
		...
		lblDescrio.setBounds(72, 177, 84, 16);
		panel_6.add(lblDescrio);
		
		CdaoMULL.cbxDescricao = new JComboBox();
		CdaoMULL.cbxDescricao.setModel(new DefaultComboBoxModel(new String[] {"", "Seletiva Residencial.", "Seletiva Comercial.", "Seletiva Industrial. "}));
		CdaoMULL.cbxDescricao.setBounds(232, 173, 201, 24);
		...
		contentPane.add(frame);
		 ...
		 CdaoMULL.QUERY_mMuLL_SELETIVA(Cmull);
		CdaoMULL.txtCOD_MULL.setText(cDISPONIBILIDADE.getCOD_MULL());
		 CdaoDISPONIBILIDADE.DiasDAsemana(cDISPONIBILIDADE);
		  CdaoDISPONIBILIDADE.DisponibilidadeColetaMatutino();
