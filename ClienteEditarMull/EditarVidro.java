...
public class EditarVidro extends JFrame {
	...
	public EditarVidro() {
		...
		CdaoMULL.cbxPeso.setModel(new DefaultComboBoxModel(new String[] {"", "ate 1kg", "de 1 a 2kg", "de 2 a 5kg", "de 5 a 10kg", "de 10 a 20kg", "de 20 a 50kg", "+ de 50kg"}));
		...
		contentPane.add(frame);
		 ...
		 Cmull.setCOD_MULL(cDISPONIBILIDADE.getCOD_MULL());
		  CdaoDISPONIBILIDADE.DiasDAsemana(cDISPONIBILIDADE);
		  CdaoDISPONIBILIDADE.DisponibilidadeColetaMatutino();
		  CdaoMULL.QUERY_mMuLL_VIDRO(Cmull);
