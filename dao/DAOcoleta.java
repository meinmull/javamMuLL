	...
	public void IniciarColetasQuerymMuLL() {
		...
		conexao c = new conexao();
			try {
				...
				tblConsulta.getColumnModel().getColumn(1).setPreferredWidth(120);
				tblConsulta.getColumnModel().getColumn(2).setPreferredWidth(12);
				tblConsulta.getColumnModel().getColumn(3).setPreferredWidth(101);
				tblConsulta.getColumnModel().getColumn(4).setPreferredWidth(101);
				tblConsulta.getColumnModel().getColumn(5).setPreferredWidth(101);
