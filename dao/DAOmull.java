...
public class DAOmull {
	...
	public void QuerymMuLLViewDetalhesEmpresaMull(Mull mull) {
		...
		if (mull.getDES_TAB().equals("METAL")) {
			mull.setQuerySelect(
		...
		else if (mull.getDES_TAB().equals("VIDRO")) {
			mull.setQuerySelect(
		...
		else if (mull.getDES_TAB().equals("SELETIVA")) {
			mull.setQuerySelect(
		...
		else if (mull.getDES_TAB().equals("ELETRONICO")) {
			mull.setQuerySelect("SELECT DES_ELETRONICO, PES_ELETRONICO, OBS_ELETRONICO, PCS_ELETRONICO FROM `eletrônico` e inner join mmull mm on mm.COD_ELETRONICO = e.COD_ELETRONICO where mm.COD_mMuLL = ");
